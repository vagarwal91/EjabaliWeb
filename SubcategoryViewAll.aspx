<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubcategoryViewAll.aspx.cs" Inherits="eJABALI.SubcategoryViewAll" %>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-12 form-group">
          ...
          <p>Latest from : <a href="#;"><asp:Label ID="lblsubcatname" runat="server"></asp:Label></a></p>
          <div class="sub-category-main-info">
            <h1 class="info-head"><asp:Label ID="lblsubcattype" runat="server"></asp:Label></h1>
        ...
        <asp:DataList ID="DLSubcatproducts" runat="server" RepeatDirection="Vertical">
            <ItemTemplate>          
      <div class="row">
        <div class="col-md-12 form-group">
          <div class="sub-category-item-box">
            <a href="#;" target="_blank" rel="noopener noreferrer">
              <div class="row">
                <div class="col-md-3">
                  <div class="item-img">
                    <img src="./images/mi-redmi.jpeg" class="img-responsive" alt=""/>
