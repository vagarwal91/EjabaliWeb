<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="eJABALI.UserControls.Footer" %>

<!-- info start -->
<section>
  <div class="info-footer">
    <h1 class="info-header">
        ll<span class="title">Top Stories:</span>
      <a href="#;" class="sub-title">Brand Directory</a>
    </h1>
    <div class="item">
      <span class="badge badge-success item-head">
        Most searched for on ezabali
      </span>
      <a href="#;" class="dynamic-link">Ezabali Quick</a>
      <a href="#;" class="dynamic-link">TV & Appliances Shop From Home Days</a>
      <a href="#;" class="dynamic-link">Grand Home Appliances Sale</a>
      <a href="#;" class="dynamic-link">Ezabali Super Cooling Days</a>
      <a href="#;" class="dynamic-link">Big Screen Televisions</a>
      <a href="#;" class="dynamic-link">TV & Large Appliances Big Savings Day Sale</a>
      <a href="#;" class="dynamic-link">Akshaya Tritiya Offers</a>
      <a href="#;" class="dynamic-link">Ed A Mamma Clothing</a>
      <a href="#;" class="dynamic-link">Books</a>
      <a href="#;" class="dynamic-link">Ezabali Electronics: TV & Home Appliances Sale</a>
      <a href="#;" class="dynamic-link">Ezabali Cooling Days</a>
      <a href="#;" class="dynamic-link">AC Cooling Days 2021</a>
      <a href="#;" class="dynamic-link">Refrigerator Cooling Days 2021</a>
      <a href="#;" class="dynamic-link">Grand Kitchen & Home Appliances Sale</a>
      <a href="#;" class="dynamic-link">Auto Accessories Store</a>
      <a href="#;" class="dynamic-link">Streak Sunglasses</a>
      <a href="#;" class="dynamic-link">Gold Coins</a>
      <a href="#;" class="dynamic-link">Ezabali Plus</a>
      <a href="#;" class="dynamic-link">Ezabali Super Coin</a>
      <a href="#;" class="dynamic-link">Ezabali COVID-19 Insurance</a>
      <a href="#;" class="dynamic-link">Ezabali Help Centre</a>
      <a href="#;" class="dynamic-link">Ezabali Track Orders</a>
      <a href="#;" class="dynamic-link">Ezabali Manage Orders</a>
      <a href="#;" class="dynamic-link">Ezabali Return Orders</a>
      <a href="#;" class="dynamic-link">Auto Accessories Store</a>
      <a href="#;" class="dynamic-link">Contact Lenses</a>
      <a href="#;" class="dynamic-link">Ezabali Gift Cards Store</a>
      <a href="#;" class="dynamic-link">Super Fan Show</a>
      <a href="#;" class="dynamic-link">Sarees</a>
      <a href="#;" class="dynamic-link">Ezabali Axis Bank Credit Card</a>
      <a href="#;" class="dynamic-link">Ezabali Videos</a>
      <a href="#;" class="dynamic-link">Ezabali Pay Later</a>
      <a href="#;" class="dynamic-link">Redmi 8</a>
      <a href="#;" class="dynamic-link">Honor 20i</a>
      <a href="#;" class="dynamic-link">OPPO K1</a>
      <a href="#;" class="dynamic-link">Ezabali Axis Bank Credit Card</a>
      <a href="#;" class="dynamic-link">Earrings</a>
      <a href="#;" class="dynamic-link">Mens Watches</a>
      <a href="#;" class="dynamic-link">Silver Coins</a>
      <a href="#;" class="dynamic-link">Jewellery</a>
      <a href="#;" class="dynamic-link">Watches</a>
      <a href="#;" class="dynamic-link">Gold Coin</a>
      <a href="#;" class="dynamic-link">Mangalsutra</a>
      <a href="#;" class="dynamic-link">Sunglasses</a>
      <a href="#;" class="dynamic-link">Mi Sunglasses</a>
      <a href="#;" class="dynamic-link">Backpacks</a>
      <a href="#;" class="dynamic-link">Ray Ban Sunglasses</a>
    </div>
    <div class="item">
      <span class="badge badge-success item-head">
        Mobile
      </span>
      <a href="#;" class="dynamic-link">iPhone 12 64GB</a>
      <a href="#;" class="dynamic-link">iPhone 12 Pro 512GB</a>
      <a href="#;" class="dynamic-link">iPhone 12 128GB</a>
      <a href="#;" class="dynamic-link">Vivo Y91i</a>
      <a href="#;" class="dynamic-link">Vivo Y11</a>
      <a href="#;" class="dynamic-link">Vivo Y15</a>
      <a href="#;" class="dynamic-link">Vivo Y50</a>
      <a href="#;" class="dynamic-link">Vivo Y12</a>
      <a href="#;" class="dynamic-link">Reno2 F</a>
      <a href="#;" class="dynamic-link">Oppo A12</a>
      <a href="#;" class="dynamic-link">Oppo F15</a>
      <a href="#;" class="dynamic-link">Oppo A31</a>
      <a href="#;" class="dynamic-link">Samsung A71</a>
      <a href="#;" class="dynamic-link">Samsung A51</a>
      <a href="#;" class="dynamic-link">Samsung A31</a>
      <a href="#;" class="dynamic-link">Realme X2</a>
      <a href="#;" class="dynamic-link">Realme 5</a>
      <a href="#;" class="dynamic-link">Infinix Hot 8</a>
      <a href="#;" class="dynamic-link">iPhone 11</a>
      <a href="#;" class="dynamic-link">iPhone 11 Pro</a>
      <a href="#;" class="dynamic-link">iPhone 11 Pro Max</a>
      <a href="#;" class="dynamic-link">Mobile Offers</a>
      <a href="#;" class="dynamic-link">iphone x</a>
      <a href="#;" class="dynamic-link">iphone 8</a>
      <a href="#;" class="dynamic-link">iphone 7</a>
      <a href="#;" class="dynamic-link">iphone 6</a>
      <a href="#;" class="dynamic-link">Redmi 5A</a>
      <a href="#;" class="dynamic-link">4G Mobile</a>
      <a href="#;" class="dynamic-link">Nokia Mobile</a>
      <a href="#;" class="dynamic-link">Samsung Mobile</a>
      <a href="#;" class="dynamic-link">iphone</a>
      <a href="#;" class="dynamic-link">Oppo Mobile</a>
      <a href="#;" class="dynamic-link">Vivo Mobile</a>
    </div>
    <div class="info">
      <h1 class="info-head">Ezabali: The One-stop Shopping Destination</h1>
      <p>E-commerce is revolutionizing the way we all shop in India. Why do you want to hop from one store to another in search of the latest phone when you can find it on the Internet in a single click? Not only mobiles. Ezabali houses everything you can possibly imagine, from trending electronics like laptops, tablets, smartphones, and mobile accessories to in-vogue fashion staples like shoes, clothing and lifestyle accessories; from modern furniture like sofa sets, dining tables, and wardrobes to appliances that make your life easy like washing machines, TVs, ACs, mixer grinder juicers and other time-saving kitchen and small appliances; from home furnishings like cushion covers, mattresses and bedsheets to toys and musical instruments, we got them all covered. You name it, and you can stay assured about finding them all here. For those of you with erratic working hours, Ezabali is your best bet. Shop in your PJs, at night or in the wee hours of the morning. This e-commerce never shuts down.</p>
      <p>What's more, with our year-round shopping festivals and events, our prices are irresistible. We're sure you'll find yourself picking up more than what you had in mind. If you are wondering why you should shop from Ezabali when there are multiple options available to you, well, the below will answer your question.</p>

      <h1 class="info-sub-head">Ezabali Plus</h1>
      <p>A world of limitless possibilities awaits you - Ezabali Plus was kickstarted as a loyalty reward programme for all its regular customers at zero subscription fee. All you need is 500 supercoins to be a part of this service. For every 100 rupees spent on Ezabali order, Plus members earns 4 supercoins & non-plus members earn 2 supercoins. Free delivery, early access during sales and shopping festivals, exchange offers and priority customer service are the top benefits to a Ezabali Plus member. In short, earn more when you shop more!</p>
      <p>What's more, you can even use the Ezabali supercoins for a number of exciting services, like:</p>
      <ul>
        ...
        <li>Check out https://www.ezabali.com/plus/all-offers for the entire list. Terms and conditions apply.</li>
      </ul>

      <h1 class="info-sub-head">No Cost EMI</h1>
      ...
      <h1 class="info-sub-head">EMI on Debit Cards</h1>
      <p>Did you know debit card holders account for 79.38 crore in the country, while there are only 3.14 crore credit card holders? After enabling EMI on Credit Cards, in another attempt to make online shopping accessible to everyone, Ezabali introduces EMI on Debit Cards, empowering you to shop confidently with us without having to worry about pauses in monthly cash flow. At present, we have partnered with Axis Bank, HDFC Bank, State Bank of India and ICICI Bank for this facility. More power to all our shoppers! Terms and conditions apply.</p>

      <h1 class="info-sub-head">Mobile Exchange Offers</h1>
      <p>Get an instant discount on the phone that you have been eyeing on. Exchange your old mobile for a new one after the Ezabali experts calculate the value of your old phone, provided it is in a working condition without damage to the screen. If a phone is applicable for an exchange offer, you will see the 'Buy with Exchange' option on the product description of the phone. So, be smart, always opt for an exchange wherever possible. Terms and conditions apply.</p>

      <h1 class="info-sub-head">What Can You Buy From Ezabali?</h1>
      <h1 class="info-sub-head">Mobile Phones</h1>
      <p>From budget phones to state-of-the-art smartphones, we have a mobile for everybody out there. Whether you're looking for larger, fuller screens, power-packed batteries, blazing-fast processors, beautification apps, high-tech selfie cameras or just large internal space, we take care of all the essentials. Shop from top brands in the country like Samsung, Apple, Oppo, Xiaomi, Realme, Vivo, and Honor to name a few. Rest assured, you're buying from only the most reliable names in the market. What's more, with Ezabali's Complete Mobile Protection Plan, you will never again find the need to run around service centres. This plan entails you to a number of post-purchase solutions, starting at as low as Rupees 99 only! Broken screens, liquid damage to phone, hardware and software glitches, and replacements - the Ezabali Complete Mobile Protection covers a comprehensive range of post-purchase problems, with door-to-door services.</p>

      <h1 class="info-sub-head">Electronic Devices and Accessories</h1>
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="menu-wrap">
            <div class="row">
              <div class="col-md-3">
                <h1 class="menu-head">About</h1>
                <ul>
                  <li><a href="#;">Contact Us</a></li>
                  <li><a href="#;">About Us</a></li>
                  <li><a href="#;">Careers</a></li>
                  <li><a href="#;">Ezabali Stories</a></li>
                  <li><a href="#;">Press</a></li>
                  <li><a href="#;">Ezabali Wholesale</a></li>
                  <li><a href="#;">Corporate Information</a></li>
                </ul>
              </div>
              <div class="col-md-3">
                <h1 class="menu-head">Help</h1>
                <ul>
        ...
        <div class="col-md-5">
          <div class="row">
            <div class="col-md-6">
              <div class="mail-wrap">
                <h1 class="menu-head">Mail Us: </h1>
                <p>Ezabali Internet Private Limited, </p>
            ...
            <div class="col-md-6">
              <div class="address-wrap">
                <h1 class="menu-head">Registered Office Address: </h1>
                <p>Ezabali Internet Private Limited, </p>
                <p> Buildings Alyssa, Begonia &amp; </p>
                <p> Clove Embassy Tech Village, </p>
                <p> Outer Ring Road, Devarabeesanahalli Village, </p>
  ...
  <div class="lower-footer">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <ul class="more-menu">
            <li><a href="#;"><i class="fa fa-briefcase"></i> Sell On Ezabali</a></li>
            <li><a href="#;"><i class="fa fa-star"></i> Advertise</a></li>
            <li><a href="#;"><i class="fa fa-gift"></i> Gift Cards</a></li>
            <li><a href="#;"><i class="fa fa-question-circle"></i> Help Center</a></li>
            <li>© 2007-2021 Ezabali.com</li>
          </ul>
        </div>
        <div class="col-md-4">
        ...
        <div class="form-wrap">
          <div class="row">
            <div class="col-md-12 form-group">
              <asp:TextBox runat="server" ID="txt_EmailLogin" class="form-control" placeholder="Email/Mobile"></asp:TextBox>
            </div>
            <div class="col-md-12 form-group">
               <asp:TextBox runat="server" ID="txt_PasswordLogin" TextMode="password" class="form-control" placeholder="Password"></asp:TextBox>
            </div>
            <div class="col-md-12 form-group">
              <a href="#" class="btn-link right strong">Forgot Password?</a>
            </div>
            <div class="col-md-12 form-group">
              By continuing, you agree to Ejabali <a href="#" class="btn-link light">Terms of Use</a> and <a href="#" class="btn-link light">Privacy Policy.</a>
            </div>
            <div class="col-md-12 form-group">
             <asp:Button runat="server" ID="btn_login"  type="submit" class="btn btn-warning form-control" Text="Login" OnClick="btn_login_Click"/>
            </div>
            <div class="col-md-12 form-group">
              <span class="circle-text">OR</span>
            </div>
            <div class="col-md-12 form-group">
              <input type="submit" class="btn btn-primary form-control" value="Request OTP"/>
            </div>            
            <div class="col-md-12 form-group">
              <a href="#" class="btn-link strong text-center block" data-toggle="modal" data-target="#signupModal" data-dismiss="modal">New to Ejabali? Create an account</a>
            </div>
...
<!-- sign up modal start -->
<div class="modal fade" id="signupModal" aria-modal="true" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <!-- modal body -->
      <div class="modal-body">
        <h1 class="header-text mt-0">Create a new Account</h1>
        <div class="form-wrap">
          <div class="row">
            <div class="col-md-4 form-group">
              <asp:TextBox runat="server" ID="txt_fullName" class="form-control" placeholder="Full Name"></asp:TextBox>
            </div>
            <div class="col-md-4 form-group">
               <asp:TextBox runat="server" ID="txt_Email"  class="form-control" placeholder="Email Address"></asp:TextBox>
            </div>
            <div class="col-md-4 form-group">
              <asp:TextBox runat="server" ID="txt_Phone" class="form-control" placeholder="Phone Number"></asp:TextBox>
            </div>
            <div class="col-md-4 form-group">
               <asp:TextBox runat="server" ID="txt_Password" TextMode="Password"  class="form-control" placeholder="Password"></asp:TextBox>
            </div>
            <div class="col-md-4 form-group">
              <asp:TextBox runat="server" ID="txt_CPassword" TextMode="Password" class="form-control" placeholder="Confirm Password"></asp:TextBox>
            </div>
            <div class="col-md-4 form-group">
              <asp:DropDownList runat="server" ID="ddl_city" class="form-control">
                <asp:ListItem>--Select City--</asp:ListItem>
                  <asp:ListItem>Agra</asp:ListItem>
              </asp:DropDownList>
            </div>
            <div class="col-md-8 form-group">
               <asp:TextBox runat="server" ID="txt_Address" TextMode="MultiLine" class="form-control" placeholder="Address"></asp:TextBox>
            </div>
            <div class="col-md-12 form-group">
              By continuing, you agree to Ejabali <a href="#" class="btn-link light">Terms of Use</a> and <a href="#" class="btn-link light">Privacy Policy.</a>
            </div>
            <div class="col-md-4 form-group">
              <asp:Button runat="server" ID="btn_submit" OnClick="btn_submit_Click" class="btn btn-warning" value="Continue"/>
            </div>
            <div class="col-md-4 form-group">
              <input type="submit" class="btn btn-primary" value="Existing User? Log in" data-toggle="modal" data-target="#loginModal" data-dismiss="modal"/>
            </div>
            <div class="clearfix"></div>
          </div>
        </div>
