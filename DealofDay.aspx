<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealofDay.aspx.cs" Inherits="eJABALI.DealofDay" %>
...
<section>
  <div class="item-header">
    <h1><asp:Label ID="lbldod" runat="server" Text="Deal of the Day"></asp:Label></h1>
  </div>
</section>
<!-- item header end -->
  ...
  <div class="card m-l-r-10">
    <div class="container-fluid">
      ...
      <!-- item banner start -->
        ...
        <asp:PlaceHolder ID="placeholderdod" runat="server">
